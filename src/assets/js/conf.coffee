	...
	'emotions': [
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sério',						'id': '125', 'checksum': '' }
				{ 'name': 'Sorrindo #1',				'id': '124', 'checksum': '' }

				{ 'name': 'Sorrindo #2',				'id': '605', 'checksum': '' }
				{ 'name': 'Corado',						'id': '409', 'checksum': '' }
				{ 'name': 'Enjoado',					'id': '440', 'checksum': '' }
				{ 'name': 'Novo Traço: Corado',			'id': '844', 'checksum': '' }
				{ 'name': 'Novo Traço: Enjoado',		'id': '842', 'checksum': '' }
				{ 'name': 'Novo Traço: Normal',			'id': '840', 'checksum': '' }
				{ 'name': 'Novo Traço: Preocupado',		'id': '864', 'checksum': '' }
				{ 'name': 'Novo Traço: Sério',			'id': '843', 'checksum': '' }
				{ 'name': 'Novo Traço: Sorrindo',		'id': '845', 'checksum': '' }
				{ 'name': 'Novo Traço: Sorrindo-Corado','id': '841', 'checksum': '' }
				{ 'name': 'Novo Traço: Triste',			'id': '846', 'checksum': '' }
				{ 'name': 'Traje de ciências: Corado',	'id': '455', 'checksum': '' }
				{ 'name': 'Traje de ciências: Enjoado',	'id': '456', 'checksum': '' }
				{ 'name': 'Traje de ciências: Normal',	'id': '453', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Zangada',		'id': '37', 'checksum': '' }

				{ 'name': 'Cabelo Cortado: Normal',		'id': '585', 'checksum': '' }
				{ 'name': 'Cabelo Cortado: Triste',		'id': '587', 'checksum': '' }
				{ 'name': 'Cabelo Cortado: Zangada',	'id': '586', 'checksum': '' }
				{ 'name': 'Cabelo Pintado',				'id': '361', 'checksum': '' }
				{ 'name': 'Corada',						'id': '438', 'checksum': '' }
				{ 'name': 'Flor',						'id': '328', 'checksum': '' }
				{ 'name': 'Novo Visual: Assustada',		'id': '609', 'checksum': '' }
				{ 'name': 'Novo Visual: Incomodada A',	'id': '615', 'checksum': '' }
				{ 'name': 'Novo Visual: Incomodada B',	'id': '616', 'checksum': '' }
				{ 'name': 'Novo Visual: Incomodada C',	'id': '617', 'checksum': '' }
				{ 'name': 'Novo Visual: Normal A',		'id': '613', 'checksum': '' }
				{ 'name': 'Novo Visual: Normal B',		'id': '610', 'checksum': '' }
				{ 'name': 'Novo Visual: Olhos Fechados','id': '608', 'checksum': '' }
				{ 'name': 'Novo Visual: Sorrindo A',	'id': '594', 'checksum': '' }
				{ 'name': 'Novo Visual: Sorrindo B',	'id': '607', 'checksum': '' }
				{ 'name': 'Novo Visual: Sorrindo C',	'id': '611', 'checksum': '' }
				{ 'name': 'Novo Visual: Sorrindo Corada','id': '612', 'checksum': '' }
				{ 'name': 'Novo Visual: Surpresa',		'id': '614', 'checksum': '' }
				{ 'name': 'Novo Visual: Triste',		'id': '592', 'checksum': '' }
				{ 'name': 'Novo Visual: Zangada A',		'id': '593', 'checksum': '' }
				{ 'name': 'Novo Visual: Zangada B',		'id': '595', 'checksum': '' }
				{ 'name': 'Pijama: Normal',				'id': '421', 'checksum': '' }
				{ 'name': 'Pijama: Zangada',			'id': '422', 'checksum': '' }
				{ 'name': 'Praia: Empolada',			'id': '106', 'checksum': '' }
				{ 'name': 'Praia: Normal',				'id': '104', 'checksum': '' }
				{ 'name': 'Praia: Triste',				'id': '107', 'checksum': '' }
				{ 'name': 'Praia: Zangada',				'id': '105', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Corada',	'id': '458', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Normal',	'id': '457', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Triste',	'id': '460', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Zangada',	'id': '459', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Blam',			'id': '50', 'checksum': '' }
				{ 'name': 'Braouuumm!!',	'id': '544', 'checksum': '' }
				{ 'name': 'Vrrrrrrr',		'id': '869', 'checksum': '' }
				{ 'name': 'WTF?!',			'id': '262', 'checksum': '' }
				{ 'name': 'Schpaf!',		'id': '684', 'checksum': '' }
				{ 'name': 'Tchick!',		'id': '648', 'checksum': '' }
				{ 'name': 'Ding Dong',		'id': '866', 'checksum': '' }
				{ 'name': 'Driiiiiiing',	'id': '868', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',		'id': '61', 'checksum': '' }
				{ 'name': 'Zangada',		'id': '62', 'checksum': '' }
				{ 'name': 'Pijama',			'id': '75', 'checksum': '' }
				{ 'name': 'Triste',			'id': '599', 'checksum': '' }
				{ 'name': 'Assustada',		'id': '598', 'checksum': '' }
				{ 'name': 'Chorando #1',	'id': '806', 'checksum': '' }
				{ 'name': 'Chorando #2',	'id': '807', 'checksum': '' }
				{ 'name': 'Corada',			'id': '808', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Assustada','id': '471', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Normal',	'id': '468', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Feliz',			'id': '18', 'checksum': '' }
				{ 'name': 'Triste',			'id': '19', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',			'id': '216', 'checksum': '' }
				{ 'name': 'Corada',				'id': '217', 'checksum': '' }
				{ 'name': 'Zangada',			'id': '255', 'checksum': '' }
				{ 'name': 'Preocupada',			'id': '257', 'checksum': '' }
				{ 'name': 'Triste',				'id': '230', 'checksum': '' }
				{ 'name': 'Triste Sorrindo',	'id': '258', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',					'id': '77', 'checksum': 'd3ca72ef3e2ea54e' }
				{ 'name': 'Corada #1',					'id': '69', 'checksum': '' }
				{ 'name': 'Corada #2',					'id': '861', 'checksum': '' }
				{ 'name': 'Assustada',					'id': '590', 'checksum': '' }
				{ 'name': 'Praia: Sorrindo',			'id': '85', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Corada',	'id': '479', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Normal',	'id': '477', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Sorrindo','id': '478', 'checksum': '' }
				{ 'name': 'Traje esportivo: Normal',	'id': '145', 'checksum': '' }
				{ 'name': 'Traje esportivo: Sorrindo',	'id': '146', 'checksum': '' }
				{ 'name': 'Traje esportivo: Corada',	'id': '147', 'checksum': '' }
				{ 'name': 'Zangada #1',					'id': '857', 'checksum': '' }
...
#				{ 'name': 'Normal #2',	'id': '32', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Corado',		'id': '14', 'checksum': '3c47ab950d8d4ac0' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',	'id': '204', 'checksum': '' }
				{ 'name': 'Corado A',	'id': '206', 'checksum': '' }
				{ 'name': 'Corado B',	'id': '207', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',	'id': '67', 'checksum': '' }
				{ 'name': 'Zangada',	'id': '68', 'checksum': '' }
				{ 'name': 'Preocupada',	'id': '579', 'checksum': '' }
				{ 'name': 'Surpresa',	'id': '430', 'checksum': '' }
				{ 'name': 'Vovózinha',	'id': '304', 'checksum': '' }
				{ 'name': 'Fada: Normal',		'id': '306', 'checksum': '' }
				{ 'name': 'Fada: Zangada',		'id': '358', 'checksum': '' }
				{ 'name': 'Vestido: Normal',	'id': '305', 'checksum': '' }
				{ 'name': 'Vestido: Sorrindo',	'id': '370', 'checksum': '' }
				{ 'name': 'Vestido: Zangada',	'id': '369', 'checksum': '' }
				{ 'name': 'Traje esportivo: Normal',		'id': '161', 'checksum': '' }
				{ 'name': 'Traje esportivo: Sorrindo',		'id': '162', 'checksum': '' }
				{ 'name': 'Traje esportivo: Zangada',		'id': '163', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Normal',		'id': '490', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Sorrindo',	'id': '491', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',	'id': '277', 'checksum': '' }
				{ 'name': 'Feliz',		'id': '681', 'checksum': '' }
				{ 'name': 'Triste',		'id': '279', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Preocupado',		'id': '71', 'checksum': '' }
				{ 'name': 'Sorrindo #2',	'id': '848', 'checksum': '' }
				{ 'name': 'Corado',			'id': '72', 'checksum': '' }
				{ 'name': 'Triste',			'id': '797', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',		'id': '49', 'checksum': '' }
				{ 'name': 'Corado A',		'id': '86', 'checksum': '' }
				{ 'name': 'Corado B',		'id': '118', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo',		'id': '58', 'checksum': '' }
				{ 'name': 'Preocupada',		'id': '59', 'checksum': '' }
				{ 'name': 'Triste-Corada',	'id': '646', 'checksum': '' }
				{ 'name': 'Zangada',		'id': '425', 'checksum': '' }
				{ 'name': 'Assustada',		'id': '805', 'checksum': '' }
				{ 'name': 'Surpresa',		'id': '647', 'checksum': '' }
				{ 'name': 'Pijama',			'id': '74', 'checksum': '' }
				{ 'name': 'Traje esportivo: Normal',		'id': '153', 'checksum': '' }
				{ 'name': 'Traje esportivo: Sorrindo',		'id': '154', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Normal',		'id': '497', 'checksum': '' }
				{ 'name': 'Traje de Ciências: Preocupada',	'id': '499', 'checksum': '' }
...
#				{ 'name': 'Boxers: Corado #2',				'id': '426', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Colar Azul',		'id': '243', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sorrindo A',	'id': '239', 'checksum': '' }
...
#				{ 'name': 'Normal',				'id': '38', 'checksum': '' }
	...
	'avatars': [
		...
		{ 'name': 'Lysandre',				'id': '23', 'checksum': '' }
		{ 'name': 'Peggy',					'id': '24', 'checksum': '' }
		{ 'name': 'Melody',					'id': '25', 'checksum': '' }
		{ 'name': 'Bia',					'id': '26', 'checksum': '' }
		{ 'name': 'Violette',				'id': '27', 'checksum': '' }
		{ 'name': 'Kim',					'id': '28', 'checksum': '' }
		{ 'name': 'Leigh',					'id': '29', 'checksum': '' }
		{ 'name': 'Dragon',					'id': '30', 'checksum': '' }
		{ 'name': 'Dake',					'id': '31', 'checksum': '' }
		{ 'name': 'Dimitri',				'id': '32', 'checksum': '' }
		{ 'name': 'Morcego',				'id': '33', 'checksum': '' }
		{ 'name': 'Alexy',					'id': '34', 'checksum': '' }
		{ 'name': 'Armin',					'id': '35', 'checksum': '' }
		{ 'name': 'Cotton',					'id': '36', 'checksum': '' }
		{ 'name': 'Wenka & Willi',			'id': '37', 'checksum': '' }
		{ 'name': 'Kentin',					'id': '38', 'checksum': '' }
		{ 'name': 'Nina',					'id': '39', 'checksum': '' }
		{ 'name': 'Deborah',				'id': '40', 'checksum': '' }
		{ 'name': 'Viktor',					'id': '41', 'checksum': '' }
		{ 'name': 'Tije',					'id': '42', 'checksum': '' }
		{ 'name': 'Dark Louis',				'id': '43', 'checksum': '' }
		{ 'name': 'WTF',					'id': '44', 'checksum': '' }
		{ 'name': 'Lety',					'id': '48', 'checksum': '' }
		{ 'name': 'Pai de Docete',			'id': '49', 'checksum': '' }
		{ 'name': 'Vendedora',				'id': '53', 'checksum': '' }
		{ 'name': 'Prof. Delanay',			'id': '54', 'checksum': '' }
		{ 'name': 'Thomas',					'id': '55', 'checksum': '' }
		{ 'name': 'Priya',					'id': '56', 'checksum': '' }
		{ 'name': 'Cookie',					'id': '57', 'checksum': '' }
		...
		{ 'name': 'Mãe de Castiel',			'id': '67', 'checksum': '' }
		{ 'name': 'Pai de Kentin',			'id': '68', 'checksum': '' }
		{ 'name': 'Mãe de Kentin',			'id': '69', 'checksum': '' }
		{ 'name': 'Pai de Lysandre e Leigh','id': '70', 'checksum': '' }
		{ 'name': 'Mãe de Lysandre e Leigh','id': '71', 'checksum': '' }
		{ 'name': 'Pai de Armin e Alexy',	'id': '72', 'checksum': '' }
		{ 'name': 'Mãe de Armin e Alexy',	'id': '73', 'checksum': '' }
		{ 'name': 'Mãe de Iris e Thomas',	'id': '74', 'checksum': '' }
		{ 'name': 'Pai de Violette',		'id': '75', 'checksum': '' }
		{ 'name': 'Pai de Rosalya',			'id': '76', 'checksum': '' }
		{ 'name': 'Mãe de Rosalya',			'id': '77', 'checksum': '' }
		{ 'name': 'Pai de Kim',				'id': '78', 'checksum': '' }
		{ 'name': 'Mãe de Kim',				'id': '79', 'checksum': '' }
		{ 'name': 'Pai de Peggy',			'id': '80', 'checksum': '' }
		{ 'name': 'Mãe de Peggy',			'id': '81', 'checksum': '' }
		{ 'name': 'Pai de Bia',				'id': '82', 'checksum': '' }
		{ 'name': 'Mãe de Bia',				'id': '83', 'checksum': '' }
		{ 'name': 'Pai de Melody',			'id': '84', 'checksum': '' }
		{ 'name': 'Mãe de Melody',			'id': '85', 'checksum': '' }
		{ 'name': 'Pai de Li',				'id': '86', 'checksum': '' }
		{ 'name': 'Mãe de Li',				'id': '87', 'checksum': '' }
		{ 'name': 'Pai de Charlotte',		'id': '88', 'checksum': '' }
		{ 'name': 'Mãe de Charlotte',		'id': '89', 'checksum': '' }
		{ 'name': 'Enfermeira',				'id': '90', 'checksum': '' }
		{ 'name': 'Socorro',				'id': '91', 'checksum': '' }
		{ 'name': 'Médico',					'id': '92', 'checksum': '' }
		{ 'name': 'Samuel (Sam)',			'id': '93', 'checksum': '' }
		{ 'name': 'Nathaniel (Novo Visual)','id': '130', 'checksum': '' }
		{ 'name': 'Castiel (Novo Visual)',	'id': '131', 'checksum': '' }
		{ 'name': 'Ambre (Nova)',			'id': '134', 'checksum': '' }
		{ 'name': 'Lysandre (Novo)',		'id': '135', 'checksum': '' }
		{ 'name': 'Kentin (Novo)',			'id': '136', 'checksum': '' }
		{ 'name': 'Pais de Docete',			'id': '138', 'checksum': '' }
		{ 'name': 'Ambre e amigas',			'id': '139', 'checksum': '' }
		{ 'name': 'Lysandre (Novo Visual)',	'id': '140', 'checksum': '' }
		{ 'name': 'Alexy (Novo)',			'id': '141', 'checksum': '' }
		{ 'name': 'Armin (Novo)',			'id': '142', 'checksum': '' }
		{ 'name': '[Nada]',					'id': '0',  'checksum': '-' }
		{ 'name': '[Docete]',				'id': 's',  'checksum': '-' }
	]
	'scenes': [
		{
			'name': 'Escola: Entrada'
...
#				{ 'name': 'Escura',		'id': '107', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Noite',		'id': '10', 'checksum': '' }
				{ 'name': 'Escuro',		'id': '108', 'checksum': '' }
				{ 'name': 'Sepia',		'id': '93', 'checksum': '' }
#				{ 'name': 'Dia #2',		'id': '126', 'checksum': '' }
#				{ 'name': 'Noite #2',	'id': '131', 'checksum': '' }
			]
		}
		{
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Noite',			'id': '11', 'checksum': '' }
				{ 'name': 'Sepia',			'id': '90', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Noite',			'id': '8', 'checksum': '' }
				{ 'name': 'Escuro',			'id': '103', 'checksum': '' }
				{ 'name': 'Sepia',			'id': '89', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Escuro',				'id': '981', 'checksum': '' }
				{ 'name': 'Molhado',			'id': '982', 'checksum': '' }
				{ 'name': 'Antigo: Claro',		'id': '87', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Iluminado',		'id': '955', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': '2',			'id': '23', 'checksum': '' }
				{ 'name': '3',			'id': '24', 'checksum': '' }
				{ 'name': '4',			'id': '25', 'checksum': '' }
				{ 'name': '5',			'id': '26', 'checksum': '' }
				{ 'name': '6',			'id': '27', 'checksum': '' }
				{ 'name': '7',			'id': '28', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': '2',			'id': '41', 'checksum': '' }
				{ 'name': '3',			'id': '42', 'checksum': '' }
				{ 'name': '4',			'id': '43', 'checksum': '' }
				{ 'name': '5',			'id': '44', 'checksum': '' }
				{ 'name': '6',			'id': '46', 'checksum': '' }
				{ 'name': '7',			'id': '48', 'checksum': '' }
				{ 'name': '8',			'id': '52', 'checksum': '' }
				{ 'name': '9',			'id': '62', 'checksum': '' }
				{ 'name': '10',			'id': '63', 'checksum': '' }
				{ 'name': '11',			'id': '67', 'checksum': '' }
				{ 'name': '12',			'id': '68', 'checksum': '' }
				{ 'name': '13',			'id': '69', 'checksum': '' }
				{ 'name': '14',			'id': '70', 'checksum': '' }
				{ 'name': '15',			'id': '71', 'checksum': '' }
				{ 'name': '16',			'id': '72', 'checksum': '' }
				{ 'name': '17',			'id': '73', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': '2',			'id': '147', 'checksum': '' }
				{ 'name': '3',			'id': '148', 'checksum': '' }
				{ 'name': '4',			'id': '149', 'checksum': '' }
				{ 'name': '5',			'id': '150', 'checksum': '' }
				{ 'name': '6',			'id': '151', 'checksum': '' }
				{ 'name': '7',			'id': '152', 'checksum': '' }
				{ 'name': '8',			'id': '153', 'checksum': '' }
				{ 'name': '9',			'id': '154', 'checksum': '' }
				{ 'name': '10',			'id': '155', 'checksum': '' }
				{ 'name': '11',			'id': '156', 'checksum': '' }
				{ 'name': '12',			'id': '157', 'checksum': '' }
				{ 'name': '13',			'id': '158', 'checksum': '' }
				{ 'name': '14',			'id': '159', 'checksum': '' }
				{ 'name': '15',			'id': '160', 'checksum': '' }
				{ 'name': '16',			'id': '161', 'checksum': '' }
				{ 'name': '17',			'id': '162', 'checksum': '' }
				{ 'name': '18',			'id': '163', 'checksum': '' }
				{ 'name': '19',			'id': '164', 'checksum': '' }
				{ 'name': '20',			'id': '165', 'checksum': '' }
				{ 'name': '21',			'id': '166', 'checksum': '' }
				{ 'name': '22',			'id': '167', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Noite',			'id': '226', 'checksum': '' }
				{ 'name': 'Sala de Estar',	'id': '231', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Banheiro: Noite',		'id': '264', 'checksum': '' }
				{ 'name': 'Corredor: Dia',			'id': '249', 'checksum': '' }
				{ 'name': 'Corredor: Noite',		'id': '257', 'checksum': '' }
				{ 'name': 'Cozinha: Dia',			'id': '254', 'checksum': '' }
				{ 'name': 'Cozinha: Noite',			'id': '261', 'checksum': '' }
				{ 'name': 'Jardim: Dia',			'id': '256', 'checksum': '' }
				{ 'name': 'Jardim: Noite',			'id': '263', 'checksum': '' }
				{ 'name': 'Sala de Estar: Dia',		'id': '250', 'checksum': '' }
				{ 'name': 'Sala de Estar: Noite',	'id': '260', 'checksum': '' }
				{ 'name': 'Quarto da Iris: Dia',	'id': '252', 'checksum': '' }
				{ 'name': 'Quarto da Iris: Noite',	'id': '259', 'checksum': '' }
				{ 'name': 'Quarto do Thomas: Dia',	'id': '251', 'checksum': '' }
				{ 'name': 'Quarto do Thomas: Noite','id': '258', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Banheiro: Dia',				'id': '213', 'checksum': '' }
				{ 'name': 'Banheiro: Noite',			'id': '220', 'checksum': '' }
				{ 'name': 'Primeiro Andar: Dia',		'id': '209', 'checksum': '' }
				{ 'name': 'Primeiro Andar: Noite',		'id': '217', 'checksum': '' }
				{ 'name': 'Quarto da Ambre: Dia',		'id': '211', 'checksum': '' }
				{ 'name': 'Quarto da Ambre: Noite',		'id': '221', 'checksum': '' }
				{ 'name': 'Quarto do Nathaniel: Dia',	'id': '212', 'checksum': '' }
				{ 'name': 'Quarto do Nathaniel: Noite',	'id': '216', 'checksum': '' }
				{ 'name': 'Sala de Estar: Dia',			'id': '208', 'checksum': '' }
				{ 'name': 'Sala de Estar: Noite',		'id': '218', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Elevador: Noite',	'id': '244', 'checksum': '' }
				{ 'name': 'Entrada: Dia',		'id': '233', 'checksum': '' }
				{ 'name': 'Entrada: Noite',		'id': '242', 'checksum': '' }
				{ 'name': 'Lanchonete: Dia',	'id': '235', 'checksum': '' }
				{ 'name': 'Lanchonete: Noite',	'id': '248', 'checksum': '' }
				{ 'name': 'Quarto 1: Dia',		'id': '238', 'checksum': '' }
				{ 'name': 'Quarto 1: Noite',	'id': '247', 'checksum': '' }
				{ 'name': 'Quarto 2: Dia',		'id': '239', 'checksum': '' }
				{ 'name': 'Quarto 2: Noite',	'id': '246', 'checksum': '' }
				{ 'name': 'Recepção: Dia',		'id': '234', 'checksum': '' }
				{ 'name': 'Recepção: Noite',	'id': '243', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': '2',			'id': '134', 'checksum': '' }
				{ 'name': '3',			'id': '135', 'checksum': '' }
				{ 'name': '4',			'id': '136', 'checksum': '' }
				{ 'name': '5',			'id': '137', 'checksum': '' }
				{ 'name': '6',			'id': '138', 'checksum': '' }
				{ 'name': '7',			'id': '139', 'checksum': '' }
				{ 'name': '8',			'id': '140', 'checksum': '' }
				{ 'name': '9',			'id': '141', 'checksum': '' }
				{ 'name': '10',			'id': '142', 'checksum': '' }
				{ 'name': '11',			'id': '143', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Sala de Aula B',			'id': '874', 'checksum': '' }
				{ 'name': 'Armários Colégio: Dia',	'id': '893', 'checksum': '' }
				{ 'name': 'Armários Colégio: Noite',	'id': '894', 'checksum': '' }
				{ 'name': 'Banheiro A',		'id': '876', 'checksum': '' }
				{ 'name': 'Banheiro B',		'id': '877', 'checksum': '' }
				{ 'name': 'Banheiro C',		'id': '878', 'checksum': '' }
				{ 'name': 'Banheiro D',		'id': '879', 'checksum': '' }
				{ 'name': 'Bar',			'id': '881', 'checksum': '' }
				{ 'name': 'Beco',			'id': '892', 'checksum': '' }
				{ 'name': 'Floresta',		'id': '880', 'checksum': '' }
				{ 'name': 'Rua A: Dia',		'id': '882', 'checksum': '' }
				{ 'name': 'Rua A: Tarde',	'id': '884', 'checksum': '' }
				{ 'name': 'Rua A: Noite',	'id': '883', 'checksum': '' }
				{ 'name': 'Rua B: Dia',		'id': '885', 'checksum': '' }
				{ 'name': 'Rua B: Tarde',	'id': '887', 'checksum': '' }
				{ 'name': 'Rua B: Noite',	'id': '886', 'checksum': '' }
				{ 'name': 'Rua C: Dia',		'id': '888', 'checksum': '' }
				{ 'name': 'Rua C: Noite',	'id': '889', 'checksum': '' }
				{ 'name': 'Rua D: Dia',		'id': '890', 'checksum': '' }
				{ 'name': 'Rua D: Noite',	'id': '891', 'checksum': '' }
				{ 'name': 'Rua E: Dia',		'id': '948', 'checksum': '' }
				{ 'name': 'Rua E: Tarde',	'id': '950', 'checksum': '' }
				{ 'name': 'Rua E: Noite',	'id': '949', 'checksum': '' }
				{ 'name': 'Rua F: Dia',		'id': '943', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Quarto A: Tarde',	'id': '915', 'checksum': '' }
				{ 'name': 'Quarto A: Noite #1',	'id': '913', 'checksum': '' }
				{ 'name': 'Quarto A: Noite #2',	'id': '914', 'checksum': '' }

				{ 'name': 'Quarto B: Dia',		'id': '916', 'checksum': '' }
				{ 'name': 'Quarto B: Noite',	'id': '917', 'checksum': '' }

				{ 'name': 'Quarto C: Dia',		'id': '918', 'checksum': '' }
				{ 'name': 'Quarto C: Tarde',	'id': '921', 'checksum': '' }
				{ 'name': 'Quarto C: Noite #1',	'id': '919', 'checksum': '' }
				{ 'name': 'Quarto C: Noite #2',	'id': '920', 'checksum': '' }

				{ 'name': 'Quarto D: Dia',		'id': '959', 'checksum': '' }
				{ 'name': 'Quarto D: Tarde',	'id': '961', 'checksum': '' }
				{ 'name': 'Quarto D: Escuro',	'id': '960', 'checksum': '' }
				{ 'name': 'Quarto D: Janelas Fechadas',	'id': '958', 'checksum': '' }

				{ 'name': 'Quarto E: Dia',		'id': '965', 'checksum': '' }
				{ 'name': 'Quarto E: Tarde',	'id': '967', 'checksum': '' }
				{ 'name': 'Quarto E: Escuro',	'id': '966', 'checksum': '' }
				{ 'name': 'Quarto E: Janelas Fechadas',	'id': '964', 'checksum': '' }

				{ 'name': 'Quarto F: Dia',		'id': '1001', 'checksum': '' }
				{ 'name': 'Quarto F: Noite',	'id': '1002', 'checksum': '' }
				{ 'name': 'Quarto F: Claro',	'id': '962', 'checksum': '' }
				{ 'name': 'Quarto F: Escuro',	'id': '963', 'checksum': '' }

				{ 'name': 'Quarto G: Dia',		'id': '1003', 'checksum': '' }
				{ 'name': 'Quarto G: Noite',	'id': '1004', 'checksum': '' }

				{ 'name': 'Quarto H',			'id': '1005', 'checksum': '' }
				{ 'name': 'Quarto I',			'id': '1006', 'checksum': '' }
				{ 'name': 'Quarto J',			'id': '1007', 'checksum': '' }
				{ 'name': 'Quarto K',			'id': '1008', 'checksum': '' }
				{ 'name': 'Quarto L',			'id': '1009', 'checksum': '' }
				{ 'name': 'Quarto M',			'id': '1010', 'checksum': '' }

				{ 'name': 'Quarto N: Dia',		'id': '1011', 'checksum': '' }
				{ 'name': 'Quarto N: Tarde',	'id': '1012', 'checksum': '' }

				{ 'name': 'Quarto O: Dia',		'id': '1013', 'checksum': '' }
				{ 'name': 'Quarto O: Tarde',	'id': '1015', 'checksum': '' }
		...
		}
		{
			...
			'variations': [
				...
				{ 'name': 'Porta',		'id': '99', 'checksum': '' }
				{ 'name': 'Interior',	'id': '98', 'checksum': '' }
			]
		}
	]